      ...
      <div className="w-full max-w-sm p-8 rounded-lg">
        {/* Register Form */}
          <div className="flex justify-center join join-vertical lg:join-horizontal">
            ...
            <button className="btn text-white join-item" style={{ backgroundColor: '#ED9A82' }}>Login</button>
            </Link>
            <Link href={"/front_office/register"}>
            <button className="btn text-white join-item" style={{ backgroundColor: '#B12937' }}>Register</button>
            </Link>
          </div>
